...
export default function Location() {
  return (
    <section className='mb-24 flex px-6 max-md:flex-col max-md:px-[16px]'>
      <div className='flex w-1/2 flex-col justify-between px-14 max-md:w-full max-md:px-0'>
        <h1
          className={`text-5xl font-semibold ${poppins.className} leading-tight max-md:text-3xl max-md:mb-4`}
        >
          Suntem aproape de{' '}
        ...
        <div className='mt-auto flex w-3/4 flex-col gap-4 max-md:w-full max-md:gap-2'>
      ...
      <div className='w-1/2 px-14 max-md:w-full max-md:px-0 max-md:mt-4'>
        <iframe
          width='100%'
          height='550'
